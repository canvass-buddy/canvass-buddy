...
export type UserProfile_UserFragmentFragment = { __typename?: 'User', id: string, profile?: { __typename?: 'Profile', firstName: string, lastName: string, username: string, image?: string | null } | null } & { ' $fragmentName'?: 'UserProfile_UserFragmentFragment' };

export type UserProfile_TeamMemberFragmentFragment = { __typename?: 'TeamMember', role: string } & { ' $fragmentName'?: 'UserProfile_TeamMemberFragmentFragment' };
...
export type SignUpThingMutationVariables = Exact<{
  user: SignUpInput;
}>;


export type SignUpThingMutation = { __typename?: 'Mutation', auth: { __typename?: 'AuthPayload', token: string } };

export type ScreensQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ScreensQueryQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string } | null };

export type UsernameValidationQueryVariables = Exact<{
  username: Scalars['String'];
}>;


export type UsernameValidationQuery = { __typename?: 'Query', isValid: boolean };
...
export type EmailValidationQuery = { __typename?: 'Query', isValid: boolean };
...
export type GroundViewQueryQuery = { __typename?: 'Query', user?: { __typename?: 'User', project?: { __typename?: 'Project', id: string, title: string, tasks?: Array<{ __typename?: 'Task', id: string, title: string, description: string, type: string }> | null, markers?: Array<{ __typename?: 'Marker', id: string, longitude: number, latitude: number } | null> | null, area: { __typename?: 'ProjectArea', x1: number, y1: number, x2: number, y2: number } } | null } | null };
...
export type InviteUserQueryQuery = { __typename?: 'Query', team?: (
    { __typename?: 'Team', members?: Array<{ __typename?: 'TeamMember', id: string, userId: string }> | null }
    & { ' $fragmentRefs'?: { 'TeamCard_TeamFragmentFragment': TeamCard_TeamFragmentFragment } }
  ) | null };
...
export type UserQueryQuery = { __typename?: 'Query', user?: (
    { __typename?: 'User', id: string }
    & { ' $fragmentRefs'?: { 'UserProfile_UserFragmentFragment': UserProfile_UserFragmentFragment } }
  ) | null };
...
export type TeamQueryQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string } | null, team?: (
    { __typename?: 'Team', admins?: Array<(
      { __typename?: 'TeamMember', id: string, userId: string, user: (
        { __typename?: 'User' }
        & { ' $fragmentRefs'?: { 'UserProfile_UserFragmentFragment': UserProfile_UserFragmentFragment } }
      ) }
      & { ' $fragmentRefs'?: { 'UserProfile_TeamMemberFragmentFragment': UserProfile_TeamMemberFragmentFragment } }
    )> | null, users?: Array<(
      { __typename?: 'TeamMember', id: string, user: (
        { __typename?: 'User' }
        & { ' $fragmentRefs'?: { 'UserProfile_UserFragmentFragment': UserProfile_UserFragmentFragment } }
      ) }
      & { ' $fragmentRefs'?: { 'UserProfile_TeamMemberFragmentFragment': UserProfile_TeamMemberFragmentFragment } }
...
export type ProfileScreenQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ProfileScreenQueryQuery = { __typename?: 'Query', user?: (
    { __typename?: 'User', id: string }
    & { ' $fragmentRefs'?: { 'UserProfile_UserFragmentFragment': UserProfile_UserFragmentFragment } }
  ) | null };
...
export const UserProfile_TeamMemberFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"UserProfile_TeamMemberFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TeamMember"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"role"}}]}}]} as unknown as DocumentNode<UserProfile_TeamMemberFragmentFragment, unknown>;
...
export const SignUpThingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SignUpThing"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"user"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SignUpInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"auth"},"name":{"kind":"Name","value":"signUp"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"user"},"value":{"kind":"Variable","name":{"kind":"Name","value":"user"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"token"}}]}}]}}]} as unknown as DocumentNode<SignUpThingMutation, SignUpThingMutationVariables>;
export const ScreensQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ScreensQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<ScreensQueryQuery, ScreensQueryQueryVariables>;
export const UsernameValidationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"UsernameValidation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"username"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"isValid"},"name":{"kind":"Name","value":"validUsername"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"username"},"value":{"kind":"Variable","name":{"kind":"Name","value":"username"}}}]}]}}]} as unknown as DocumentNode<UsernameValidationQuery, UsernameValidationQueryVariables>;
export const EmailValidationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EmailValidation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"email"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"isValid"},"name":{"kind":"Name","value":"validEmail"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"email"},"value":{"kind":"Variable","name":{"kind":"Name","value":"email"}}}]}]}}]} as unknown as DocumentNode<EmailValidationQuery, EmailValidationQueryVariables>;
...
export const ProfileScreenQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ProfileScreenQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"UserProfile_UserFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"UserProfile_UserFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"profile"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"image"}}]}}]}}]} as unknown as DocumentNode<ProfileScreenQueryQuery, ProfileScreenQueryQueryVariables>;
export const TeamsSearchDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"TeamsSearch"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"title"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"teams"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"title"},"value":{"kind":"Variable","name":{"kind":"Name","value":"title"}}},{"kind":"Argument","name":{"kind":"Name","value":"size"},"value":{"kind":"IntValue","value":"10"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"TeamCard_TeamFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"TeamCard_TeamFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Team"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"private"}},{"kind":"Field","name":{"kind":"Name","value":"image"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]} as unknown as DocumentNode<TeamsSearchQuery, TeamsSearchQueryVariables>;